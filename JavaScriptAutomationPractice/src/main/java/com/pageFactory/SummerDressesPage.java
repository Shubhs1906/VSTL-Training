...
public class SummerDressesPage {
	...
	By loc_imgPrintedChiffonDress = By.xpath("//a[@href='http://automationpractice.com/index.php?id_product=5&controller=product']/preceding::span[contains(text(),'Quick view')]");
	...
	public void getTextOfSummerDressesOnSummerDressesPage(){
		objBaseTest.getObjSeleniumWrapperFunctions().getText(loc_hdrSummerDresses);
	}
	
	public void scrollToProductOnSummerDressesPage(){
		//objBaseTest.getObjSeleniumWrapperFunctions().scrollToView(loc_imgPrintedChiffonDress);
	}
